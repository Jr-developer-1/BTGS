...
import { Lock, Eye, EyeOff, ShieldCheck, Check, X, KeyRound, ArrowRight, ShieldAlert } from 'lucide-react';
...
const ChangePassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(err);
            setError(err.response?.data?.error || 'Failed to change password. Please ensure your current password is correct.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="cp-wrapper">
            <style>{`
                ...
                .cp-wrapper::before {
                    background: rgba(225, 29, 72, 0.15); /* Burgundy/Rose tint */
                    top: -200px;
                    left: -200px;
                }
                .cp-wrapper::after {
                ...
                .cp-header {
                    background: linear-gradient(135deg, #be123c 0%, #881337 100%); /* Premium Burgundy Gradient */
                    padding: 40px 30px;
                    text-align: center;
                    color: white;
                    position: relative;
            ...
            <div className="cp-card">
                <div className="cp-header">
                    ...
                    <p>For your protection, please replace your temporary auto-generated password with a strong, permanent one.</p>
                </div>
                ...
                <div className="cp-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="cp-form-group">
                            <label className="cp-label">Current / Temporary Password</label>
